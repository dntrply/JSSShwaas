...
import {changeLanguage, t, languageOptions} from '../src/messages';
...
export default ({selectedLanguageLocale, onLanguageSelect}: {selectedLanguageLocale: string, onLanguageSelect: (locale: string) => void}) => {
  ...
  const chooseLanguage = function (lang: any) {
