...
import messages_hi_In from '../assets/translations/hi_IN.json';
import messages_kn_In from '../assets/translations/kn_IN.json';
import messages_te_In from '../assets/translations/te_IN.json';
import messages_bn_In from '../assets/translations/bn_IN.json';
import messages_ta_In from '../assets/translations/ta_IN.json';
import messages_mr from '../assets/translations/mr.json';
